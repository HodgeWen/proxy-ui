...
- [ ] 全局 UI 润色（动效、间距、色彩、组件一致性）
- [ ] 核心启动行为优化（不存在核心时不自动启动，提醒下载）
- [ ] 核心启动失败交互修正（不显示语义错误的"重启"按钮）
- [ ] 核心状态实时检测与展示
- [ ] 核心手动启动/停止/重启控制
- [ ] 核心版本检测优化
- [ ] 核心更新下载进度展示
...
## Current Milestone: v1.1 UI与核心优化

**Goal:** 全局润色 UI 提升视觉体验，优化核心管理的启动、状态检测和更新逻辑

**Target features:**
- 全局 UI 润色（动效、间距、色彩、组件一致性）
- 核心启动/停止/状态展示与手动控制
- 核心更新逻辑优化（版本检测、下载进度、错误处理）
