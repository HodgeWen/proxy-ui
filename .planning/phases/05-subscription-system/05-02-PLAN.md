...
1. ResetSubscriptionHandler(sm *scs.SessionManager) http.HandlerFunc
   ...
   - Optional: support SUB_URL_PREFIX env for full URL when set (e.g. https://panel.example.com) — if env set, return full URL; else return path. Per RESEARCH Open Question 1.
